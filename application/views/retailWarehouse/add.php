            ...
            <div class="row">
                <div class="col-xs-5">
                    ...
                    <div class="box">
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form action="<?= base_url('retailWarehouse/addBarang') ?>" method="POST">
                                <div class="mt-3">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="id_barang">
                                        ...
                                        <?php foreach ($kd_barang as $barang) : ?>
                                            <option value="<?= $barang['id']; ?>"><?= $barang['kode_barang']; ?><?= '('; ?><?= $barang['kemasan']; ?><?= ')'; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Input New Name" name="unit">

                                    <label for="exampleFormControlInput1" class="form-label">STOK</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Input New Stok" name="stok_barang">
                                </div>
                                <a href="<?= base_url('retailWarehouse'); ?>" class="btn btn-primary" style="float: left; margin: 5pt;"><i></i>Data Retail</a>
