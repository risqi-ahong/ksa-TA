                            ...
                            <form action="" method="POST">
                                <?php foreach ($stok_in as $in) : ?>
                                    <div class="mt-3">
                                        ...
                                        <input type="hidden" name="id_barang" value="<?= $in['id_barang']; ?>">
                                        <label>KODE</label>
                                    <select class="form-control select2" style="width: 100%;" name="id_barang" disabled = "disabled">
                                        <option selected><?= $kode['kode_barang']; ?></option>
                                        ...
                                        <input type="text" name="satuan" class="form-control" id="exampleFormControlInput1" value="<?= $in['satuan']; ?>">
